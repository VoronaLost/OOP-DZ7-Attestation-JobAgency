...
public class Company {
    ...
    public void needEmployee(){
        ...
        } else System.out.println("У компании " + this.name + " сейчас нет открытых вакансий");
    ...
    public void showOpenVacancies(){
        if (openVacancies.size() == 0) System.out.println("У компании " + name + " нет открытых вакансий на данный момент");
        else {
